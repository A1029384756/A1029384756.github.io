...
function preload() {
  ...
  loadImage('/assets/exit_door.png', (img) => {
  ...
  loadImage('/assets/restart_button.png', (img) => {
    sprite_manager.add_sprite('restart_button', img, 2)
  })
  loadImage('/assets/win_card.png', (img) => {
    sprite_manager.add_sprite('win_card', img, 1)
  })
  loadImage('/assets/lose_card.png', (img) => {
    sprite_manager.add_sprite('lose_card', img, 1)
  })
  loadImage('/assets/heart.png', (img) => {
  ...
  loaded_levels = /** @type {Level[]} */ (loadJSON('/assets/levels.json'))
}
